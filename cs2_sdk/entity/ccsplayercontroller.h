...
public:
	...
	SCHEMA_FIELD(CHandle<C_CSPlayerPawn>, m_hPlayerPawn)
	SCHEMA_FIELD(CHandle<C_CSPlayerPawnBase>, m_hObserverPawn)
	...
	static CCSPlayerController* FromPawn(C_CSPlayerPawn* pawn)
	{
	...
	CSPlayerState GetPawnState()
	{
		...
		C_CSPlayerPawnBase *pPawn = (C_CSPlayerPawnBase*)GetPawn();
	...
	{
		C_CSPlayerPawn *pPawn = GetPlayerPawn();
