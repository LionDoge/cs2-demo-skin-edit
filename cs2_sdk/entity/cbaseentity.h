...
{
public:
	DECLARE_SCHEMA_CLASS(C_BaseEntity)
	...
	SCHEMA_FIELD(CHandle<C_BaseEntity>, m_hEffectEntity)
	SCHEMA_FIELD(CHandle<C_BaseEntity>, m_hOwnerEntity)
	...
	CHandle<C_BaseEntity> GetHandle() { return m_pEntity->m_EHandle; }
...
class SpawnPoint : public C_BaseEntity
{
public:
